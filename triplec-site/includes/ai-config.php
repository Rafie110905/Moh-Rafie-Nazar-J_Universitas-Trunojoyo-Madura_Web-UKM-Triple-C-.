...
define('GEMINI_API_KEY', 'GANTI_DENGAN_API_KEY_ANDA');

// Alias model — otomatis mengikuti versi terbaru Gemini Flash, jadi
// tidak perlu diganti manual walau Google update modelnya.
// 'gemini-flash-lite-latest' = kuota gratis paling besar (disarankan).
// 'gemini-flash-latest' = sedikit lebih pintar, kuota gratis lebih kecil.
